...
* Simon SD. Centers for Disease Control and Prevention. In Encyclopedia of Big Data. Schintler LA, McNeely CL (eds.). In press.

* Simon SD. Census Bureau (U.S.). In Encyclopedia of Big Data. Schintler LA, McNeely CL (eds.). In press.
...
fn <- "~/resume/data/training-classes-list.txt"
